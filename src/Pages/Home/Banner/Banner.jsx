...
import im4 from"../../../assets/images/banner/4.jpg";
...
const Banner = () => {
    return (
        ...
        <div id="slide1" className="carousel-item relative w-full">
          ...
          <div className="absolute h-full flex items-center left-0 right-5 top-0 bg-gradient-to-r from-[#151515] to-[rgba(21,21,21,0)]">
          <div className='text-white space-y-7 pl-12 w-1/3'>
            <h2 className='font-bold text-5xl'>Affordable<br/> Price For Car Servicing</h2>
